...
Invoke me with: `/this-sus [context]`

Examples:
- `/this-sus` — review recent changes (git diff HEAD)
- `/this-sus src/auth/login.ts` — review a specific file
- `/this-sus src/` — review an entire directory
